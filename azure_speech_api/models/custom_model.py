...
import six
from azure_speech_api.models.shared_model import SharedModel  # noqa: F401,E501

class CustomModel(SharedModel):
    ...
    if hasattr(SharedModel, "swagger_types"):
        swagger_types.update(SharedModel.swagger_types)
    ...
    if hasattr(SharedModel, "attribute_map"):
        attribute_map.update(SharedModel.attribute_map)

    def __init__(self, project=None, links=None, properties=None, text=None, base_model=None, datasets=None, custom_properties=None, *args, **kwargs):  # noqa: E501
        ...
        SharedModel.__init__(self, *args, **kwargs)
