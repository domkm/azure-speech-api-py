...
class Transcription(object):
    ...
    def __init__(self, links=None, properties=None, _self=None, model=None, project=None, dataset=None, content_urls=None, content_container_url=None, locale=None, display_name=None, description=None, custom_properties=None, last_action_date_time=None, status=None, created_date_time=None):  # noqa: E501
