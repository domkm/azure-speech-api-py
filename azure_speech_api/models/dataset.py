...
class Dataset(object):
    ...
    def __init__(self, links=None, properties=None, kind=None, _self=None, display_name=None, description=None, project=None, content_url=None, custom_properties=None, locale=None, last_action_date_time=None, status=None, created_date_time=None):  # noqa: E501
