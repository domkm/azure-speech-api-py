...
class EndpointLinks(object):
    ...
    def __init__(self, rest_interactive=None, rest_conversation=None, rest_dictation=None, web_socket_interactive=None, web_socket_conversation=None, web_socket_dictation=None, logs=None):  # noqa: E501
