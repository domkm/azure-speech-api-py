...
class Endpoint(object):
    ...
    def __init__(self, project=None, links=None, properties=None, _self=None, display_name=None, description=None, text=None, model=None, locale=None, custom_properties=None, last_action_date_time=None, status=None, created_date_time=None):  # noqa: E501
